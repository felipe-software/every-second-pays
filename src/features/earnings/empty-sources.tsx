...
export function EmptySourcesCallout({ bottomInset }: { bottomInset: number }) {
    ...
    const { t } = useI18n();
    const arrow = `<svg xmlns="http://www.w3.org/2000/svg" width="156" height="90" viewBox="0 0 156 90" fill="none"><g stroke="${colors.accentDeep}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 8 C48 3 118 12 129 48 C132 58 132 68 130 81" stroke-dasharray="6 7"/><path d="M118 68 Q124 76 130 82 Q138 76 144 69"/></g></svg>`;
    ...
    return (
        <View
            ...
            style={{ bottom: Math.max(bottomInset + 4, 12) }}
        >
